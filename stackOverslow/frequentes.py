...
class StackoverflowTopQuestionsSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        #usa a API de seletores CSS e XPATH para iterar sobre elementos HTML das perguntas obtido com o seletor "#QUESTIONS > DIV"
        #gerando um objeto Question para cada com os campos preenchidos.
